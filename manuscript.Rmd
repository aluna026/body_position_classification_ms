...
The proximal and distal comparison videos for each participant were annotated by trained human coders to identify infant body position: supine, prone, sitting, sitting restrained, upright, or held. All coding was done using Datavyu software (datavyu.org). 
