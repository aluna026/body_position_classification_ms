...
metric_plot <- function(ds, met) {
  ds %>% filter(metric == met) %>% 
    ggplot(aes(x = Model, y = value, shape = Model)) + 
    geom_sina(alpha = .7, fill = "orange", size = 4, maxwidth = .5) +
    stat_summary(fun = "mean", mapping = aes(x = Model, y = value), shape = "-", fill = "black", size = 4) + 
    scale_shape_manual(guide = "none", values = c(21,23)) + 
...
timelines <- function(ds) {
  ...
  breaks = as_hms(c('09:00:00', '10:00:00', '11:00:00', '12:00:00', '13:00:00', '14:00:00', '15:00:00', '16:00:00', '17:00:00', '18:00:00', '19:00:00', '20:00:00', '21:00:00'))
  ...
  scale_x_time(breaks = breaks_width("4 hour"), name = "", limits = lims) + 
