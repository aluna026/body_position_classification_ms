...
We report four sets of results based on `r length(unique(ppts$id_uni))` full-day testing sessions resulting in a total of `r sum(duration$duration_hours)` hours of movement recording. 
