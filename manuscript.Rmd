...
```{r exemplartimeline, out.width="0.9\\linewidth", include=TRUE, fig.align="center", fig.cap="Example Timeline Caption.", echo=FALSE}
...
# > pt2_start_time
# [1] "2022-11-13 11:11:00 PST"
# > pt2_end_time
# [1] "2022-11-13 12:41:01 PST"
# > session_param$start_time_coded
# [1] "2022-11-13 10:02:40 PST"
```
...
apa_table(class_table, col.names = c("Metric","Position", "Median", "Mean", "SD", "Median", "Mean", "SD"), col_spanners = list("Group" = c(3, 5), "Individual" = c(6, 8)),
          ...
          caption = "Model performance metrics for each body position class, shown separately for group and individual models.")
```
...
## Goal 3: Examine wear time and compliance in full-day data collection
...
## Goal 4: Determine sensitivity of classification to measure age differences in body position
<!-- imu-compiled.csv, generated from analysis-lena-imu/compile_lena_imu.R -->
