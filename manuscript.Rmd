...
```{r metrics, warning=FALSE, fig.cap="Metrics", fig.align="center", fig.width=5, fig.height=8, cache=TRUE, cache.extra=tools::md5sum("data/group_split_metrics.csv")}
...
<!-- GET RID OF BALANCED ACCURACY AND F1, MOVE KAPPA UP, THEN DO SENS/PPV -->
