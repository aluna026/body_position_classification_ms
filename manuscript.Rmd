...
```{r metric-stable, cache=TRUE, cache.extra=tools::md5sum("data/group_split_metrics.csv")}
...
```{r metricsbyclass, cache=TRUE, cache.extra=tools::md5sum("data/group_split_metrics_class.csv")}
...
Figure \@ref(fig:metrics)) and Table \@ref(tab:metrics-table)) summarize the performance of group and individual models using standard metrics for classification. 
